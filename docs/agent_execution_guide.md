...
| `worker.integrity --all` | **PASS — independent populations** | FIXTURES and CORPUS reported separately without unioning (item E0 delivered). Real assessments loaded (9 checked). `verify_source_productivity` coverage half is tracked in R1. |
