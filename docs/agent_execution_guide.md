...
| 2 | **D5** | 41% of the claims vanished in D1's re-extraction | none | **outstanding** | 3,669 → 2,174, double §13u step 5's investigate-threshold, unmentioned. One 90-minute episode is down to a single claim. The run's rejection counters were never reported, so there is no record of why. |
